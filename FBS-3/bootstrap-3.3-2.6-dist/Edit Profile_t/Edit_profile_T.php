...
<div class="container">
	<div class="row">
        <div class="col-md-6">
            <form action='Edit_profile_T.php' method='POST' id="Form1" role="form1" >
...
<input class="form-control" rows="3"  name="Description" value="<?php echo $Tr_education; ?>" placeholder=">>"></input>
</div>
...
if(isset($_POST["update"])){
	 ...
	 $dbpass  = 'root';
	 $connection = new mysqli($dbhost, $dbuser, $dbpass, $dbname);
	 $query = "CALL Update_trainer('$firstname','$lastname','$email','$Age','$Address','$state','$zipcode','$City','$phonenumber','$reg_gender','$pic','$resume','$Description')";
	$result = mysqli_query($connection, $query);
 echo '<br />';
 echo '<br />';
 echo '<br />';
 echo '<br />';
			 ...
			 if($result)
			{
				...
				echo"<script>alert('YOU HAVE CHANGE SECSUSSFLY')</script>";
