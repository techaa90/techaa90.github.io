...
include("../headers/header.html");
 ...
 <body>
  ...
  <h5> Welocme Dear Trainer ...</h5>
 <ul class="nav nav-tabs">
  <li role="presentation"><a href="Register.php">Customer</a></li>
  <li role="presentation" class="active"><a href="#">Trainer</a></li>
...
<div class="container">
	<div class="row">
        <div class="col-md-6">
            ...
            <form action='Register_t.php' method='POST' id="fileForm" role="form" >
  ...
  $query = "CALL check_email('$email')";
      ...
      if($check == 1)
      {
      ...
      else
       {
         ...
         $query = "CALL add_trainer('$firstname','$lastname','$email','$Age','$password','$Address','$state','$zipcode','$City','$phonenumber','$reg_gender' , '$photo' ,'$resume','$education','$education','$education')";
         $result = mysqli_query($connection, $query);
