     ...
     ?>
         ...
         <div class= "container">
           ...
           <div class="col-xs-6">
             ...
             <form action="../admin_page/services.php" method="GET">
             <p><button type="submit" class="btn btn-default" href="../admin_page/services.php" name="view_details" value="<?php echo $event_id;?>" role="button">View details &raquo;</button></p>
           </form>
             <br> <br> <br> <br> <br>
           </div><!-- /.col-lg-4 -->
