  ...
  <div class="container">
    ...
    <div id="navbar" class="navbar-collapse collapse">
      ...
      <!--  <li><a href="../bootstrap-3.3.6/bootstrap-3.3.6/docs/examples/Home/index.html">Home</a></li> -->
          <li><a href="../customer_page/trainer.php">Event</a></li>



            <li><a href="../calendar_T/index.php">schedule</a></li>
             ...
             <li><a href="../Social media/media.php">Social Media</a></li>
                 ...
                 <li class="#" class="Dropdown">
                    ...
                    <ul class="dropdown-menu">
                      <li><a href="../Edit Profile_t/Edit_profile_T.php">Edit Profile</a></li>
  ...
  <form class="navbar-form navbar-right">
    ...
    <div id="navbar" class="navbar-collapse collapse">
      <form class="navbar-form navbar-right">
        ...
        session_start();
?>
                <button type="text" class="btn btn-default">Welcome,<?php echo $first_name; ?></button>
